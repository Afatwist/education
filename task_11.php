...
function errorShow($error)
{
	...
	if ($error == 'email already use') $desc = 'Этот e-mail уже занят другим пользователем';

	if	($error == 'not registration') $desc = 'Что-то пошло не так!';

	if ($error == 'complete') $desc = 'Регистрация прошла успешно!';
						...
						<div class="panel-content">
							<div class="form-group">
								...
								<form action="task_11_handler.php" method="POST">
									...
									<button class="btn btn-success mt-3">Зарегистрироваться</button>
								</form>
							</div>
						</div>
					</div>
